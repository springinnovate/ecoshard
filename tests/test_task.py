...
class TaskGraphTests(unittest.TestCase):
    """Tests for the ecoshard.taskgraph."""
    ...
    def test_single_task(self):
        ...
        task_graph = ecoshard.taskgraph.TaskGraph(self.workspace_dir, 0, 0.1)
    ...
    def test_task_broken_chain(self):
        ...
        task_graph = ecoshard.taskgraph.TaskGraph(self.workspace_dir, 4)
        target_a_path = os.path.join(self.workspace_dir, 'a.dat')
        target_b_path = os.path.join(self.workspace_dir, 'b.dat')
        result_path = os.path.join(self.workspace_dir, 'result.dat')
        value_a = 5
    ...
    def test_get_file_stats(self):
        ...
        from ecoshard.taskgraph.Task import _get_file_stats
    ...
    def test_transient_runs(self):
        ...
        task_graph2 = ecoshard.taskgraph.TaskGraph(self.workspace_dir, -1)
    ...
    def test_modifying_functions_with_copy(self):
        ...
        def run_a_batch(a_path, b_path, volatile_path, d_path):
            ...
            task_graph = ecoshard.taskgraph.TaskGraph(self.workspace_dir, -1, 0)
            task_a = task_graph.add_task(
                func=_a,
                args=(a_path, b_path),
    ...
    def test_terminate_log(self):
        ...
        task_graph = ecoshard.taskgraph.TaskGraph(self.workspace_dir, 1, 5.0)
        _ = task_graph.add_task()
        task_graph.join()
    ...
    def test_filter_non_files(self):
        ...
        from ecoshard.taskgraph.Task import _filter_non_files
        from ecoshard.taskgraph.Task import _normalize_path
